...
import { Plus, Trash2, IndianRupee, Calendar } from 'lucide-react';
    ...
    >
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-2">Manage employee salary advances.</p>
        </div>
        <button
              ...
              {loading ? (
                ...
                advances.map((adv) => (
                  <tr key={adv.id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className="font-semibold text-slate-900">{adv.full_name}</div>
                      <div className="text-xs text-slate-500">ID: #{adv.employee_id}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="font-semibold text-amber-600 flex items-center gap-1">
                        <IndianRupee size={16} /> {adv.amount.toLocaleString()}
                      </div>
                    </td>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500"
                >
